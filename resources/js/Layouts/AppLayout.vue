                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex items-center">
                                ...
                                <!-- Input Menu with Submenu -->
                                <div class="relative group h-[100%]">
                                    <!-- Main Menu Item -->
                                    <NavLink :href="route('input')" :active="route().current('input')"
                                             class="mt-5 inline-block">
                                        Input
                                    </NavLink>
                                    <!-- Submenu for Input -->
...
<!--                                            <li><a href="/input/sub2" class="block px-4 py-2 hover:bg-gray-200">Submenu 2</a></li>-->
                                ...
                                <!-- Output Menu with Submenu -->
                                <div class="relative group h-[100%]">
                                    <!-- Main Menu Item -->
                                    <NavLink :href="route('output')" :active="route().current('output')"
                                             class="mt-5 inline-block">
                                        Output
                                    </NavLink>
                                    <!-- Submenu for Output -->
...
<!--                                    >-->
<!--                                        <ul class="py-2">-->
<!--                                            <li><a href="/output/sub1" class="block px-4 py-2 hover:bg-gray-200">Submenu 1</a></li>-->
<!--                                            <li><a href="/output/sub2" class="block px-4 py-2 hover:bg-gray-200">Submenu 2</a></li>-->
<!--                                        </ul>-->
<!--                                    </div>-->
                                </div>
                            </div>
